...
| `sub_version_mode` | `全部子版本`（**默认**）/ `最新子版本`（每组合只取最新一档） |

常用例子：
| 想要的效果 | 选择 | 目标数 |
|---|---|---|
| **只构建 6.1 的全部子版本（默认）** | `kernel_scope=6.1` | 23 |
| 6.1 只取最新一档 | `kernel_scope=6.1` + `最新子版本` | 1 |
| 6 系列全部子版本 | `6系列` + `全部子版本` | 46 |
| 5 系列全部子版本 | `5系列` + `全部子版本` | 87 |
| 全部版本 × 全部子版本 | `全部` + `全部子版本` | 133 |
| 每版本最新（默认） | `全部` + `最新子版本` | 7 |
...
| android14-6.1 | 23 | 172 / 2026-06 |
| android15-6.6 | 17 | 139 / 2026-07 |
| android16-6.12 | 6 | 81 / 2026-06 |
